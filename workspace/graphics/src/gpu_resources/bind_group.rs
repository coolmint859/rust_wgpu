...
use crate::{
    ...
    wpgu_context::{HoldPolicy, ResourceID}
};
...
impl ResourceBuilder for BindGroupBuilder {
    ...
    fn hold_time(&self) -> Option<u64> { HoldPolicy::Volatile.as_seconds() }

    fn build(&self, context: Arc<BindGroupContext>, _cancel_flag: Arc<AtomicBool>) -> Result<Self::Output, String> {
