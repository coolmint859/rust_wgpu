...
impl ResourceBuilder for BufferBuilder {
    ...
    fn hold_time(&self) -> Option<u64> { HoldPolicy::Dynamic.as_seconds() }

    fn build(&self, context: Arc<BufferContext>, _cancel_flag: Arc<AtomicBool>) -> Result<Arc<wgpu::Buffer>, String> {
