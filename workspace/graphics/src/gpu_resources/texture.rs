...
use crate::{handler::ResourceBuilder, wpgu_context::HoldPolicy};
...
impl ResourceBuilder for SamplerBuilder {
    ...
    fn hold_time(&self) -> Option<u64> { HoldPolicy::Persistent.as_seconds() }

    fn build(&self, device: Arc<wgpu::Device>, _cancel_flag: Arc<AtomicBool>) -> Result<Arc<wgpu::Sampler>, String> {
...
impl ResourceBuilder for TextureBuilder {
    ...
    fn build(&self, context: Arc<TextureContext>, _cancel_flag: Arc<AtomicBool>) -> Result<Self::Output, String> {
