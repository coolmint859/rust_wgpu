...
use crate::{
   ...
   shader::ShaderSpecBuilder, texture::SamplerBuilder, 
   vertex::*, 
   wpgu_context::ResourceID
};
...
impl ShaderSpecPreset {
    ...
    pub fn path(&self) -> String {
        match self {
            ShaderSpecPreset::ColoredSprite => "workspace/graphics/shaders/colored_sprite.wgsl".to_string(),
            ShaderSpecPreset::TexturedSprite => "workspace/graphics/shaders/textured_sprite.wgsl".to_string(),
            ShaderSpecPreset::AnimatedSprite => "workspace/graphics/shaders/animated_sprite.wgsl".to_string(),
            ShaderSpecPreset::Font => "workspace/graphics/shaders/font.wgsl".to_string(),
        }
    }
